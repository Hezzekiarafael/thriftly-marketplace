  ...
  useEffect(() => {
    const loadPending = async () => {
      try {
        ...
        // Asumsikan getAllComplaints itu sinkron dari localstorage seperti sebelumnya
                    ...
                    <>
                      ...
                      {openComplaints.map(complaint => (
                        ...
                        >
                          ...
                          <div>
                            <p className="text-xs font-bold text-gray-900">Aduan Baru Masuk</p>
                            <p className="text-[11px] text-gray-500 mt-0.5">{complaint.subjek}</p>
                            <span className="text-[10px] font-semibold text-red-600 hover:text-red-800 mt-1 block">Klik untuk balas</span>
                          </div>
                        </div>
                      ))}
