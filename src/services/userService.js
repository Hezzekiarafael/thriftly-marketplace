...
export const mapLaravelUser = (u) => {
  ...
  return {
    ...
    email_verified_at: u.email_verified_at || u.emailVerifiedAt || null,
    phoneVerifiedAt: u.phone_verified_at || u.phoneVerifiedAt || u.profile?.phone_verified_at || null,
    phone_verified_at: u.phone_verified_at || u.phoneVerifiedAt || u.profile?.phone_verified_at || null,
